...
const English = {
  ...
  modalBody: {
    aboutWebsite: {
      ...
      content1:
        'This site is designed for easy search of recipes for the entered ingredients. In order to use it correctly, please read the instructions below.',
      annotation:
        'You can return to this instruction by clicking on the question mark in the upper right corner of the site.'
    },
    aboutSearch: {
    ...
    aboutRecipes: {
      ...
      content1:
        'You can scroll through the list of recipes until it starts to repeat. You do not need to manually navigate through the search pages.',
      content2:
        'To display detailed information about the recipe, click on its name and wait for the modal window to appear. You can exit this window by clicking on the cross in the upper right or by clicking outside the modal window area.',
      content3:
    ...
    aboutMap: {
      ...
      annotation:
        'For the map to work properly, be sure to provide data about your location. This information is used exclusively to find nearby stores. We do not collect user statistics.'
    },
    invited: {
...
const Russian = {
  ...
  modalBody: {
    ...
    aboutRecipes: {
      header: 'Про рецепты',
      content1:
        'Вы можете листать список рецептов до тех пор, пока он не начнёт повторятся. Вам не нужно вручную переключаться по страницам поиска.',
      content2:
        'Для отображения подробной информации о рецепте нажмите на его название и долждитесь отображения модального окна. Вы можете выйти из этого окна нажав на крестик справа вверху или нажав вне области модального окна.',
      content3:
    ...
    aboutMap: {
      ...
      annotation:
        'Для правильной работы карты обязательно предоставьте данные о вашем местоположении. Эта информация используется исключительно для нахождения ближайших магазинов. Мы не собираем статистику пользователей.'
    },
    invited: {
